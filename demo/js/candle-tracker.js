(function() {
   ...
   * @type {number}
   */
  tracking.CandleTracker.prototype.minGroupSize = 30;
  ...
  tracking.CandleTracker.prototype.trackColor_ = function(pixels, width, height) {
    ...
    while(i--) {
      ...
      if (rowWidth > (data.width * .75)) {
        results.splice(i, 1);
        console.log('spliced: ' + rowWidth);
        continue;
      }
